 ...
 * @author Izaltino
 */
public class CoordenadorCadastrarSalasTela extends javax.swing.JFrame {

    /**
     * Creates new form CoordenadorCadastrarMateriasTela
     */
    public CoordenadorCadastrarSalasTela() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CoordenadorCadastrarSalasTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CoordenadorCadastrarSalasTela().setVisible(true);
            }
        });
    }
