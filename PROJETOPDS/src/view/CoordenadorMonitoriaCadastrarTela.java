 ...
 * @author Izaltino
 */
public class CoordenadorMonitoriaCadastrarTela extends javax.swing.JFrame {

    /**
     * Creates new form MonitoriaCadastrarTela
     */
    public CoordenadorMonitoriaCadastrarTela() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CoordenadorMonitoriaCadastrarTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CoordenadorMonitoriaCadastrarTela().setVisible(true);
            }
        });
    }
